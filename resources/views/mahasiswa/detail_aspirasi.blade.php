...
<div class="container">
    ...
    <div class="card p-4 shadow-sm mb-4">
        ...
        <div class="d-flex gap-2 mt-4">
            <a href="{{ route('aspirasi.edit') }}" class="btn btn-warning btn-sm">
                <i class="bi bi-pencil-square"></i> Edit
            </a>
            <form action="{{ route('aspirasi.destroy') }}" method="POST" onsubmit="return confirm('Yakin ingin menghapus aspirasi ini?')">
                @csrf
                @method('DELETE')
